...
public:
    ...
    void getImage(GLint level, GLenum format, GLenum type, GLvoid *pixels) const {
        glGetTextureImage(glId(), level, format, type, pixels);
    }

    void setParameter(GLenum pname, GLfloat param) {
        glTextureParameterf(glId(), pname, param);
    }

    void setParameter(GLenum pname, GLint param) {
        glTextureParameteri(glId(), pname, param);
    }
    ...
    void generateMipmap() {
        glGenerateTextureMipmap(glId(), textureType);
    }
...
public:
    /*   void setImage(GLint level, GLenum internalFormat, GLsizei width, GLsizei height,
           ...
           glTextureImage2D(glId(), GL_TEXTURE_2D, level, internalFormat, width, height,
    ...
    void setSubImage(GLint level,
        ...
        GLenum type,
        const GLvoid * data) {
        glTextureSubImage2D(glId(), level, xoffset, yoffset, width, height,
            format, type, data);
    }
...
class GLTexture3D: public GLMultiLayerTexture<GL_TEXTURE_3D> {
    ...
    GLsizei m_nDepth = 0;
public:
    void setSubImage(GLint level, GLsizei width, GLsizei height, GLsizei depth,
        GLenum format, GLenum type, const GLvoid* data) {
        glTextureSubImage3D(glId(), level, 0, 0, 0, width, height, depth,
            format, type, data);
        m_nWidth = width;
        m_nHeight = height;
        m_nDepth = depth;
...
//    //    GLint border, GLenum format, GLenum type, const GLvoid* data) {
//    //    glTextureImage2D(glId(), GL_TEXTURE_CUBE_MAP_POSITIVE_X + face, level, internalFormat, width, height,
//    //        border, format, type, data);
//    //}
//
//    //void setStorage(GLint face, GLint levels, GLenum internalFormat, GLsizei width, GLsizei height) {
//    //    glTextureStorage2D(glId(), GL_TEXTURE_CUBE_MAP_POSITIVE_X + face, levels, internalFormat, width, height);
//    //}
//
//    //void setStorage(GLint levels, GLenum internalFormat, GLsizei width, GLsizei height) {
//    //    glTextureStorage2D(glId(), GL_TEXTURE_CUBE_MAP, levels, internalFormat, width, height);
//    //}
//};
//
...
//        glTextureImage3D(glId(), GL_TEXTURE_2D_ARRAY, level, internalFormat, width, height, nbLayers,
//            border, format, type, data);
//        m_nWidth = width;
//        m_nHeight = height;
...
//        GLenum type,
//        const GLvoid * data) {
//        glTextureSubImage3D(glId(), GL_TEXTURE_2D_ARRAY, level, xoffset, yoffset, zoffset, width, height, nbLayers,
//            format, type, data);
//    }
//
//    void setSubImage(
...
//    void setStorage(GLint levels, GLenum internalFormat, GLsizei width, GLsizei height,
//        GLsizei nbLayers) {
//        glTextureStorage3D(glId(), GL_TEXTURE_2D_ARRAY, levels, internalFormat, width, height, nbLayers);
//        m_nWidth = width;
//        m_nHeight = height;
//        m_nLayerCount = nbLayers;
//    }
...
//    void setImage(GLint level, GLenum internalFormat, GLsizei width, GLsizei height,
//        GLsizei nbLayers, GLint border, GLenum format, GLenum type, const GLvoid* data) {
//        glTextureImage3D(glId(), GL_TEXTURE_CUBE_MAP_ARRAY, level, internalFormat, width, height, 6 * nbLayers,
//            border, format, type, data);
//        m_nWidth = width;
//        m_nHeight = height;
//        m_nLayerCount = nbLayers;
...
//    void setStorage(GLint levels, GLenum internalFormat, GLsizei width, GLsizei height,
//        GLsizei nbLayers) {
//        glTextureStorage3D(glId(), GL_TEXTURE_CUBE_MAP_ARRAY, levels, internalFormat, width, height, 6 * nbLayers);
//        m_nWidth = width;
//        m_nHeight = height;
//        m_nLayerCount = nbLayers;
//    }
