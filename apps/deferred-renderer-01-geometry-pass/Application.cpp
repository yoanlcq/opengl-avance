...
void Application::initShadersData()
{
    ...
    m_uDirectionalLightDirLocation = glGetUniformLocation(m_geometryPassProgram.glId(), "uDirectionalLightDir");
    m_uDirectionalLightIntensityLocation = glGetUniformLocation(m_geometryPassProgram.glId(), "uDirectionalLightIntensity");

    m_uPointLightPositionLocation = glGetUniformLocation(m_geometryPassProgram.glId(), "uPointLightPosition");
    m_uPointLightIntensityLocation = glGetUniformLocation(m_geometryPassProgram.glId(), "uPointLightIntensity");
